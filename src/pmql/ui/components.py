...
QMainWindow, QWidget#root, QWidget#page { background: #f1f5f9; }
...
QLabel#pageTitle { font-size: 22px; font-weight: 700; color: #0f172a; }
...
/* ── Tables ──────────────────────────────────────────────── */
QTableWidget { background: #ffffff; alternate-background-color: #f8fafc; color: #0f172a; border: none; border-radius: 0; gridline-color: #f1f5f9; selection-background-color: #fff7ed; selection-color: #0f172a; outline: none; }
