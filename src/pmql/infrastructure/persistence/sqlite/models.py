...
class ShiftModel(Base):
    ...
    shift_type: Mapped[str] = mapped_column(String(50), default="")
    starting_cash: Mapped[int] = mapped_column(Integer, default=0)
    notes: Mapped[str | None] = mapped_column(Text, nullable=True)
    start_time: Mapped[datetime] = mapped_column(DateTime)
    end_time: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    total_sessions: Mapped[int] = mapped_column(Integer, default=0)
    total_revenue: Mapped[int] = mapped_column(Integer, default=0)
    actual_ending_cash: Mapped[int | None] = mapped_column(Integer, nullable=True)
