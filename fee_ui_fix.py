...
# 1. Update icon_btn
old_icon_btn_def = 'def icon_btn(icon_name: str, text: str, style: str = _BTN_EDIT_STYLE, size: int = 16) -> QPushButton:'
new_icon_btn_def = 'def icon_btn(icon_name: str, text: str, style: str = _BTN_EDIT_STYLE, size: int = 16, icon_color: str = "white") -> QPushButton:'
old_qta_icon = 'ico = qta.icon(icon_name, color=color)'
new_qta_icon = 'ico = qta.icon(icon_name, color=icon_color)'

if old_icon_btn_def in content:
    content = content.replace(old_icon_btn_def, new_icon_btn_def)
    content = content.replace('color = "white"\n                ico = qta.icon(icon_name, color=color)', new_qta_icon)

# 2. Extract fee_page block and replace it
